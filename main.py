...
# # Streamlit UI
# st.title("Assistan Chatbot")

# st.button("New Chat", on_click=llm_functions.new_chat, key="new_chat_btn")
...
#         content = message.get("content", "")
#     elif isinstance(message, str):
#         # Assume that strings are assistant messages
#         role = "assistant"
#         content = message
#     else:
...
# # React to user input
# if prompt := st.chat_input("How can I help?", key="help_btn"):
#     # Display user message in chat message container
#     st.chat_message("user").markdown(prompt)
#     # Add user message to chat history
#     st.session_state.messages.append({"role": "user", "content": prompt})
